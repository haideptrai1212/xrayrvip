...
install_XrayR() {
    ...
    if  [ $# == 0 ] ;then
        ...
        wget -N --no-check-certificate -O /usr/local/XrayR/XrayR-linux.zip https://punpn.xyz/XrayRVIP/XrayR-Fastvnteam.zip
        if [[ $? -ne 0 ]]; then
        ...
        last_version=$1
        url="https://punpn.xyz/XrayRVIP/XrayR-Fastvnteam.zip"
    ...
    curl -o /usr/bin/XrayR -Ls https://punpn.xyz/XrayRVIP/XrayR.sh
